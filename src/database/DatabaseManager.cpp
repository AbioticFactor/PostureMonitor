...
// struct DatabaseManager::CardInfo {
//     int id;
//     std::string name;
//     int mana_cost;
//     std::string color;
...
void DatabaseManager::addCard(int id, const std::string& name, int mana_cost, const std::string& color, 
...
std::vector<DatabaseManager::CardInfo> DatabaseManager::searchCards(const std::string& keywords, 
